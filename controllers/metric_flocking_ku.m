...
% Import the data
metrics_01_iter_1 = readtable("C:\Users\maxim\Desktop\Master\MA2\Distributed intelligent systems\Projet\DIS-Project\controllers\metrics flocking\ku = 0.5, kw = 0.3\flocking_metrics_iter_1.csv", opts);
metrics_01_iter_2 = readtable("C:\Users\maxim\Desktop\Master\MA2\Distributed intelligent systems\Projet\DIS-Project\controllers\metrics flocking\ku = 0.5, kw = 0.3\flocking_metrics_iter_2.csv", opts);
metrics_01_iter_3 = readtable("C:\Users\maxim\Desktop\Master\MA2\Distributed intelligent systems\Projet\DIS-Project\controllers\metrics flocking\ku = 0.5, kw = 0.3\flocking_metrics_iter_3.csv", opts);
metrics_01_iter_4 = readtable("C:\Users\maxim\Desktop\Master\MA2\Distributed intelligent systems\Projet\DIS-Project\controllers\metrics flocking\ku = 0.5, kw = 0.3\flocking_metrics_iter_4.csv", opts);
...
title("Flocking metrics with Ku = 0.3");
xlabel("Time [s]");
ylabel("Accuracy []");
hold off
...
M4 = "Velocity of the team ";
legend([a1,a2,a3,a4], [M1, M2, M3, M4]);
title("Flocking metrics with Ku = 0.5");
xlabel("Time [s]");
ylabel("Accuracy []");
hold off
...
M4 = "Velocity of the team ";
legend([a1,a2,a3,a4], [M1, M2, M3, M4]);
title("Flocking metrics with Ku = 0.6");
xlabel("Time [s]");
ylabel("Accuracy []");
hold off
...
% Data iter_2
datametrics = table2array(metrics_01_iter_4);
datametrics = datametrics(1:end-1,:);
...
M4 = "Velocity of the team ";
legend([a1,a2,a3,a4], [M1, M2, M3, M4]);
title("Flocking metrics with Ku = 0.7");
xlabel("Time [s]");
ylabel("Accuracy []");
hold off

mean_Fitness(4) = mean(datametrics(:,2));
mean_Orientation(4) = mean(datametrics(:,3));
mean_Distance(4) = mean(datametrics(:,4));
mean_Velocity(4) = mean(datametrics(:,5));

std_Fitness(4) = std(datametrics(:,2));
std_Orientation(4) = std(datametrics(:,3));
std_Distance(4) = std(datametrics(:,4));
std_Velocity(4) = std(datametrics(:,5));

saturarion_perf(4,:) = datametrics(end,2:5);
...
ylabel("Accuracy []");
xlabel("Forward control coefficient, Ku []");
