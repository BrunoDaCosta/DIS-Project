...
#define RULE2_WEIGHT        (0.04/10)	   // Weight of dispersion rule. default 0.02/10
...
int main(){ 
	...
	for(;;){
		...
		printf("Robot %s: --> x: %f, y: %f\n",robot_name,my_position[0],my_position[1]);
