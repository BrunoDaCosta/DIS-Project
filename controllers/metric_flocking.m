...
title("Flocking metrics with migration weight = 0.01");
xlabel("Time [s]");
ylabel("Accuracy []");
hold off
...
M4 = "Velocity of the team ";
legend([a1,a2,a3,a4], [M1, M2, M3, M4]);
title("Flocking metrics with migration weight = 0.015");
xlabel("Time [s]");
ylabel("Accuracy []");
hold off
...
M4 = "Velocity of the team ";
legend([a1,a2,a3,a4], [M1, M2, M3, M4]);
title("Flocking metrics with migration weight = 0.02");
xlabel("Time [s]");
ylabel("Accuracy []");
hold off
