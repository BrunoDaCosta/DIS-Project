...
% Import the data
metrics_01_iter_1 = readtable("C:\Users\maxim\Desktop\Master\MA2\Distributed intelligent systems\Projet\DIS-Project\controllers\metrics flocking\flocking_metrics_disp_02.csv", opts);
metrics_01_iter_2 = readtable("C:\Users\maxim\Desktop\Master\MA2\Distributed intelligent systems\Projet\DIS-Project\controllers\metrics flocking\flocking_metrics_disp_05.csv", opts);
metrics_01_iter_3 = readtable("C:\Users\maxim\Desktop\Master\MA2\Distributed intelligent systems\Projet\DIS-Project\controllers\metrics flocking\flocking_metrics_disp_08.csv", opts);
nb_iter = 3;
nb_fit = 4;
...
title("Flocking metrics with dispersion weight = 0.02");
xlabel("Time [s]");
ylabel("Accuracy []");
hold off
...
M4 = "Velocity of the team ";
legend([a1,a2,a3,a4], [M1, M2, M3, M4]);
title("Flocking metrics with dispersion weight = 0.05");
xlabel("Time [s]");
ylabel("Accuracy []");
hold off
...
M4 = "Velocity of the team ";
legend([a1,a2,a3,a4], [M1, M2, M3, M4]);
title("Flocking metrics with dispersion weight = 0.08");
xlabel("Time [s]");
ylabel("Accuracy []");
hold off
